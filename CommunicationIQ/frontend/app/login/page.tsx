...
const DEMO = [
  { label: "Student", email: "aarav.reddy1@stmarys.edu" },
  { label: "Trainer", email: "trainer1@stmarys.edu" },
  { label: "Institution admin", email: "admin@stmarys.edu" },
  { label: "Platform", email: "admin@saashx.ai" },
];
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mt-6 pt-4 border-t border-border">
            ...
            <div className="grid grid-cols-2 gap-1.5">
              {DEMO.map((d) => (
                <button
                  ...
                  className="btn btn-ghost btn-sm justify-start ds-focus"
                >
                  {d.label}
                </button>
              ))}
            ...
            <p className="text-[10px] text-muted mt-2">
              Seeded demo estate — password <code className="kbd">Password123!</code>
            </p>
          </div>
        </div>
      </div>
